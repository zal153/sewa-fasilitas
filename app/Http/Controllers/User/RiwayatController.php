...
class RiwayatController extends Controller
{
    public function riwayat(Request $request)
    {
        ...
        return view('user.riwayat.index', compact('peminjaman', 'no', 'perPage', 'start', 'end', 'adaNonMahasiswa'));
    }
    ...
    public function print($id)
    {
        ...
        $pdf = PDF::loadView('user.riwayat.print', compact('peminjaman'));
    ...
    public function destroy($id)
    {
        ...
        $peminjaman->delete();
        return redirect()->route('riwayat')->with('success', 'Peminjaman telah dihapus.');
    }
}
