                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-6 py-4 bg-[#F2F4F9] dark:bg-dark-card-two dk-border-one">Fasilitas
                                        </th>
                                        <th class="p-6 py-4 bg-[#F2F4F9] dark:bg-dark-card-two dk-border-one">Waktu Mulai
                                        </th>
                                        <th class="p-6 py-4 bg-[#F2F4F9] dark:bg-dark-card-two dk-border-one">Waktu Selesai
                                        </th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                                    @foreach ($jadwal as $item)
                                        <tr>
                                            ...
                                            <td class="p-6 py-4 dk-border-one">{{ $item->fasilitas->nama_fasilitas ?? '_' }}</td>
                                            <td class="p-6 py-4 dk-border-one">{{ $item->waktu_mulai }}</td>
                                            <td class="p-6 py-4 dk-border-one">{{ $item->waktu_selesai }}
                                            </td>
