            ...
            <div class="col-span-full">
                <div class="card p-0">
                    <div class="flex-center-between p-6 pb-4 border-b border-gray-200 dark:border-dark-border">
                        <h3 class="text-lg card-title leading-none">Edit Jadwal</h3>
                    </div>
                    <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}" class="p-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="w-full mb-4">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="date" name="tanggal_mulai"
                                        ...
                                        value="{{ old('tanggal_mulai', $jadwal->waktu_mulai->format('Y-m-d')) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="time" name="jam_mulai"
                                        class="form-input !rounded-l-none bg-[#F8F8F8] dark:bg-dark-card-two"
                                        value="{{ old('jam_mulai', $jadwal->waktu_mulai->format('H:i')) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="time" name="jam_selesai"
                                        class="form-input !rounded-l-none bg-[#F8F8F8] dark:bg-dark-card-two"
                                        value="{{ old('jam_selesai', $jadwal->waktu_selesai->format('H:i')) }}" required>
                                </div>
                            </div>
                        </div>
